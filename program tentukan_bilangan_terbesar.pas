program tentukan_bilangan_terbesar;
uses crt;
label ulang;
...
begin
   ...
   IF(bilangan1 > bilangan2) AND (bilangan2 >= bilangan3) THEN
        writeln('Urutan terbesar ke terkecil: ', bilangan1,' ', bilangan2,' ', bilangan3);
   IF(bilangan1 > bilangan3) AND (bilangan3 > bilangan2) THEN
        writeln('Urutan terbesar ke terkecil: ', bilangan1,' ', bilangan3,' ', bilangan2);
   IF(bilangan2 > bilangan1) AND (bilangan1 >= bilangan3) THEN
        writeln('Urutan terbesar ke terkecil: ', bilangan2,' ', bilangan1,' ', bilangan3);
   IF(bilangan2 > bilangan3) AND (bilangan3 > bilangan1) THEN
        writeln('Urutan terbesar ke terkecil: ', bilangan2,' ', bilangan3,' ', bilangan1);
   IF(bilangan3 > bilangan1) AND (bilangan1 > bilangan2) THEN
        writeln('Urutan terbesar ke terkecil: ', bilangan3,' ', bilangan1,' ', bilangan2);
   IF(bilangan3 > bilangan2) AND (bilangan2 >= bilangan1) THEN
        writeln('Urutan terbesar ke terkecil: ', bilangan3,' ', bilangan2,' ', bilangan1);
